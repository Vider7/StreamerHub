...
Show the live queue on stream: add a browser source in OBS pointing at `http://127.0.0.1:51324/overlay.html`. Transparent background, current song plus what's queued (long queues auto-scroll five at a time, long titles glide through). Compact enough to tuck in a corner. It follows your dashboard theme automatically.
